...
{
    char c;
    cout << "attString is " << attString << endl;
  ...
  //  if (attString.find (":",i) == string::npos)
    ...
    //-----------------------------
        cout << "j = " << j << endl;
        string nextParam = attString.substr (0,j);
        cout << "***" << nextParam << endl;
        string restOfLine = attString.substr (j+1);
        cout << "restofline = " << restOfLine << "\n" << endl;
      //  if (restOfLine.size() > 2)
      //  {
          readAttributes (restOfLine,j);
//        }
  //      else
    //    {
      //      nextParam = attString.substr (j+1);
        //    cout << "$$$" << nextParam << endl;
        //}
    }
}
